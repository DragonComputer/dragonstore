<?php
// HTTP
define('HTTP_SERVER', 'http://store.dragon.computer/admin/');
define('HTTP_CATALOG', 'http://store.dragon.computer/');

// HTTPS
define('HTTPS_SERVER', 'http://store.dragon.computer/admin/');
define('HTTPS_CATALOG', 'http://store.dragon.computer/');

// DIR
define('DIR_APPLICATION', '/home/admin/web/store.dragon.computer/public_html/admin/');
define('DIR_SYSTEM', '/home/admin/web/store.dragon.computer/public_html/system/');
define('DIR_LANGUAGE', '/home/admin/web/store.dragon.computer/public_html/admin/language/');
define('DIR_TEMPLATE', '/home/admin/web/store.dragon.computer/public_html/admin/view/template/');
...
define('DIR_CATALOG', '/home/admin/web/store.dragon.computer/public_html/catalog/');
